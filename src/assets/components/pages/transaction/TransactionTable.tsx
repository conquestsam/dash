          ...
          <table className="min-w-full leading-normal">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr>
                ...
                <td className="px-5 py-5 bg-white text-sm">
                  <p className="text-gray-900 whitespace-nowrap">25 Sept, 12.30 AM</p>
                </td>
                <td className="px-5 py-5 bg-white text-sm text-center">
                  <p className="text-magenta whitespace-nowrap">-$3,500</p>
                </td>
              ...
              <tr>
                ...
                <td className="px-5 py-5 bg-white text-sm">
                  <p className="text-gray-900 whitespace-nowrap">27 Sept, 11.15 AM</p>
                </td>
                <td className="px-5 py-5 bg-white text-sm text-center">
